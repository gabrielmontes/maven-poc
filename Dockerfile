...
RUN apk add busybox-extras nmap wget tar zip unzip tzdata bash curl lsof libcurl findutils file mailcap
...
# Copy code to /app:
COPY target/*-exec.jar /opt/helloworld/application.jar
